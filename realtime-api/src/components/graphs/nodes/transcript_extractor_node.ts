...
export class TranscriptExtractorNode extends CustomNode {
   ...
   */
  process(context: ProcessContext, streamWithMetadata: DataStreamWithMetadata): InteractionInfo {
    ...
    const interactionComplete = (metadata.interaction_complete as boolean) || false;
