...
/**
 * Interface for STT node operations.
 * Both AssemblyAISTTWebSocketNode and PrimitiveSTTNode implement this interface.
 */
export interface ISTTNode {
 ...
 * @deprecated Use ISTTNode instead
 */
export interface IAssemblyAINode extends ISTTNode {}
